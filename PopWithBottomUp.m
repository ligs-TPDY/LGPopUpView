...
#import "PopWithBottomUp.h"
@interface PopWithBottomUp ()
@property (nonatomic,strong) PopShowView *showView;
@property (nonatomic,assign) NSInteger referenceHeight;
@end
@implementation PopWithBottomUp
///自定义显示区域的UI
+ (PopWithBottomUp *)addShowSubView:(UIView *)view
{
    UIWindow * window = [[[UIApplication sharedApplication] delegate] window];
    PopWithBottomUp *pop = [[PopWithBottomUp alloc]initWithFrame:CGRectMake(window.frame.origin.x, window.frame.origin.y, lgScreenWidth, lgScreenHeight)];
